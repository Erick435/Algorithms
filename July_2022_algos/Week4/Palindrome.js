...
console.log(AnyPalindrome(str1))
console.log(AnyPalindrome(str2))
console.log(AnyPalindrome(str3))
console.log(AnyPalindrome(str4))
console.log(AnyPalindrome(str5))
console.log(AnyPalindrome(str6))