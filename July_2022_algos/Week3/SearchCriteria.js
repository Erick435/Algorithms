...
//primitives (ints, strings, booleans) and a list of objects return 
//any object that matches all the key value pairs in the 
//search critera object
...
// console.log(findObjects(items, "Smith"))





// console.log(search1(items, "Bob"));
...
console.log(searchObjects(people, "Jo", "firstName"))