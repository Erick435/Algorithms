...
// const allProducts = (shoppingCart, wishList) => {
//     let temp = [];
...
const finalCart = (cart, wishlist) => {
    let finalCart = [];
    finalCart = [...cart];
    for (let i = 0; i < wishlist.length; i++) {
        if (!finalCart.includes(wishlist[i])) {
            finalCart.push(wishlist[i]);
        }
    }
...
console.log(finalCart(shoppingCart3, wishList3))
